...
Claude 4.6 was used for assistance writing code for parts of the get_pitch() function to convert stereo files to mono and to normalize them to 32 bit floats for use pitch detecting. No other LLMs were used.
